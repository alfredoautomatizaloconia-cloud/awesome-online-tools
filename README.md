...
- [TinyTools](https://tinytools-smoky.vercel.app/) - 30+ free single-purpose browser-based tools — favicon generator, color palette, OG image generator, SEO meta generator, AI cost calculator, background remover, image upscaler, PDF-to-Markdown, MCP config generator, and more. No signup, client-side, open source.
